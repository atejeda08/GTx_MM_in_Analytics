...
data <- read.table("C:/Users/jtejeda/OneDrive - Clarios/Documents/VS Code Projects/GTx_MM_in_Analytics/R_projects/uscrime.txt", stringsAsFactors = FALSE, header = TRUE)
